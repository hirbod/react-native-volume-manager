...
// show the native volume toast globally (iOS only currently)
// Warning: using setVolume() will always reset to the setting passed via showUI. Make sure to re-call this function if you changed between the values.
...
| ------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Volume**                                                                                  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `VolumeManager.showNativeVolumeUI(config: { enabled:boolean }) => Promise` (async)          | Disable the native volume toast when using hardware buttons (iOS only currently, Android coming soon).                                                                                                                                                                                                                                                                                                                                                                                                                                         |
