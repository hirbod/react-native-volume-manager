...
| **Hook**<br /><br />`const isSilent = useSilentSwitch(interval?: number);` | Returns a boolean if the iOS silent switch is active. Returns undefined on other platforms. The inverval is optional and controls how often the native thread should check for changes. Defaults to 2 (seconds). Mininum is 0.5.                                                                                                                                                                                                                                                                    |
